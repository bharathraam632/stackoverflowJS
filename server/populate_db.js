...
const populate = async () => {
  await userCreate('hamkalo', 'password123', 'Ham Kalo', 'hamkalo@example.com', '1234567890', 'Software Developer', '/path/to/profilepic');
  await userCreate('azad', 'password456', 'Azad Khan', 'azad@example.com', '9876543210', 'Web Developer', '/path/to/profilepic');
  await userCreate('abaya', 'password789', 'Abaya Singh', 'abaya@example.com', '1231231234', 'Data Scientist', '/path/to/profilepic');
  await userCreate('alia', 'password789', 'Alia Patel', 'alia@example.com', '9876543210', 'Software Engineer', '/path/to/profilepic');
  await userCreate('sana', 'password789', 'Sana Khan', 'sana@example.com', '1231231234', 'Full Stack Developer', '/path/to/profilepic');
  await userCreate('abhi3241', 'password789', 'Abhi Sharma', 'abhi3241@example.com', '9876543210', 'Backend Developer', '/path/to/profilepic');
  await userCreate('mackson3332', 'password789', 'Mackson Singh', 'mackson3332@example.com', '1231231234', 'Data Engineer', '/path/to/profilepic');
  await userCreate('ihba001', 'password789', 'Ihba Patel', 'ihba001@example.com', '9876543210', 'Software Developer', '/path/to/profilepic');
  await userCreate('Joji John', 'password789', 'Joji John', 'jojijohn@example.com', '1231231234', 'Frontend Developer', '/path/to/profilepic');
  await userCreate('saltyPeter', 'password789', 'Salty Peter', 'saltypeter@example.com', '9876543210', 'Mobile App Developer', '/path/to/profilepic');
  await userCreate('monkeyABC', 'password789', 'Monkey ABC', 'monkeyabc@example.com', '1231231234', 'DevOps Engineer', '/path/to/profilepic');
  await userCreate('elephantCDE', 'password789', 'Elephant CDE', 'elephantcde@example.com', '9876543210', 'Machine Learning Engineer', '/path/to/profilepic');
